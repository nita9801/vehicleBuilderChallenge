...
createVehicle(): void {
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers: any) => {
        const wheels = answers.wheels.split(',').map((wheel: string) => new Wheel(parseInt(wheel.trim()), 'DefaultBrand'));
        const Car = new car(
          Cli.generateVin(),
          answers.color,
          answers.make,
          ...
          wheels,
          // Add a default towing capacity for cars
        );
    ...
    inquirer
      ...
      .then((answers: any) => {
        ...
        const motorbike = new Motorbike(
          ...
          parseInt(answers.topSpeed),
          wheels,
          0 // Add a default towing capacity for motorbikes
        ...
        class FindVehicleToTow {
          ...
          constructor(vehicles: Vehicle[], selectedVehicleVin: string) {
            this.vehicles = vehicles;
